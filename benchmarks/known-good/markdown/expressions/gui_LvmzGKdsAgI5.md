---
guideline_id: gui_LvmzGKdsAgI5
source_path: src/coding-guidelines/expressions/gui_LvmzGKdsAgI5.rst
source_sha: 1c7d6bb9448a25401db3b411d1783cd4e78fc718
tier: strict
title: 'Avoid out-or-range shifts'
metadata:
  id: gui_LvmzGKdsAgI5
  category: mandatory
  status: draft
...
in shift left and shift right expressions [cite:gui_LvmzGKdsAgI5:FLS-BIT-EXPRESSIONS]
are defined by this guideline to be *out-of-range shifts*.
The Rust FLS incorrectly describes this behavior as arithmetic overflow [cite:gui_LvmzGKdsAgI5:FLS-ISSUE-632].
...
This rule is based on The CERT C Coding Standard Rule [cite:gui_LvmzGKdsAgI5:CERT-C-INT34].
...
## Non-Compliant Example 1 (non_compl_ex_KLiDMsCesLx7)
...
## Compliant Example 1 (compl_ex_Ux1WqHbGKV73)
...
## Compliant Example 2 (compl_ex_Ux1WqHbGKV74)
...
- gui_LvmzGKdsAgI5:CERT-C-INT34 :: SEI CERT C Coding Standard. "INT34-C. Do not shift an expression by a negative number of bits." https://wiki.sei.cmu.edu/confluence/x/ItcxBQ
- gui_LvmzGKdsAgI5:FLS-BIT-EXPRESSIONS :: The Rust FLS. "Expressions - Bit Expressions." https://rust-lang.github.io/fls/expressions.html#bit-expressions
- gui_LvmzGKdsAgI5:FLS-ISSUE-632 :: The Rust FLS Repository. "Issue 632." https://github.com/rust-lang/fls/issues/632

## Citation Signals

- citations: gui_LvmzGKdsAgI5:CERT-C-INT34, gui_LvmzGKdsAgI5:FLS-BIT-EXPRESSIONS, gui_LvmzGKdsAgI5:FLS-ISSUE-632
- std_refs: (none)
