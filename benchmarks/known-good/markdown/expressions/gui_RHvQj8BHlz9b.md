---
guideline_id: gui_RHvQj8BHlz9b
source_path: src/coding-guidelines/expressions/gui_RHvQj8BHlz9b.rst
source_sha: 1c7d6bb9448a25401db3b411d1783cd4e78fc718
tier: strict
title: 'Do not shift an expression by a negative number of bits or by greater than or equal to the bitwidth of the operand'
metadata:
  id: gui_RHvQj8BHlz9b
  category: advisory
  status: draft
...
in shift left and shift right expressions [cite:gui_RHvQj8BHlz9b:FLS-BIT-EXPRESSIONS]
are defined by this guideline to be *out-of-range shifts*.
The Rust FLS incorrectly describes this behavior as arithmetic overflow [cite:gui_RHvQj8BHlz9b:FLS-ISSUE-632].
...
This rule is based on The CERT C Coding Standard Rule [cite:gui_RHvQj8BHlz9b:CERT-C-INT34].
...
## Non-Compliant Example 1 (non_compl_ex_O9FZuazu3Lcn)
...
## Non-Compliant Example 2 (non_compl_ex_mvkgTL3kulZ5)
...
## Non-Compliant Example 3 (non_compl_ex_O9FZuazu3Lcm)
...
## Non-Compliant Example 4 (non_compl_ex_O9FZuazu3Lcx)
...
## Non-Compliant Example 5 (non_compl_ex_O9FZuazu3Lcp)
...
## Compliant Example 1 (compl_ex_xpPQqYeEPGIo)
...
- gui_RHvQj8BHlz9b:CERT-C-INT34 :: SEI CERT C Coding Standard. "INT34-C. Do not shift an expression by a negative number of bits." https://wiki.sei.cmu.edu/confluence/x/ItcxBQ
- gui_RHvQj8BHlz9b:FLS-BIT-EXPRESSIONS :: The Rust FLS. "Expressions - Bit Expressions." https://rust-lang.github.io/fls/expressions.html#bit-expressions
- gui_RHvQj8BHlz9b:FLS-ISSUE-632 :: The Rust FLS Repository. "Issue 632." https://github.com/rust-lang/fls/issues/632

## Citation Signals

- citations: gui_RHvQj8BHlz9b:CERT-C-INT34, gui_RHvQj8BHlz9b:FLS-BIT-EXPRESSIONS, gui_RHvQj8BHlz9b:FLS-ISSUE-632
- std_refs: u32::checked_shl, u32::checked_shr
